...
-- [ Configuration ]
local course_name = "tsuchisakareverse" -- Name of the Course/Track
local world_pos = { x = -6063.89, y = -175.71, z = 24.15 } -- XYZ Coordinates for Marker 3d
local start_heading = 173.91
local line_1 = "Tsuchisaka"
local line_2 = "Reverse"
