...
-- [ Configuration ]
local course_name = "akinadownhill" -- Name of the Course/Track
local world_pos = { x = -3290.88, y = 4888.64, z = 414.46 } -- XYZ Coordinates for Marker 3d
local start_heading = 344.5
local line_1 = "Akina"
