...
-- [ Configuration ]
local course_name = "akinauphill" -- Name of the Course/Track
local world_pos = { x = -874.80, y = 7021.05, z = 37.11 } -- XYZ Coordinates for Marker 3d
local start_heading = 348.70
local line_1 = "Akina"
local line_2 = "Uphill"
