...
-- [ Configuration ]
local course_name = "kagarasandown" -- Name of the Course/Track
local world_pos = { x = -6685.57, y = -2664.89, z = 332.71 } -- XYZ Coordinates for Marker 3d
local start_heading = 194.9
local line_1 = "Kagarasan"
local line_2 = "Downhill"
