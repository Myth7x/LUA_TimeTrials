...
-- [ Configuration ]
local course_name = "tsuchisaka" -- Name of the Course/Track
local world_pos = { x = -3663.99, y = -2897.62, z = 226.07 } -- XYZ Coordinates for Marker 3d
local start_heading = 209.12
local line_1 = ""
local line_2 = "Tsuchisaka"
